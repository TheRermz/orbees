    ...
    public static class BankSeeder
    {
        public static async Task SeedAsync(ApiDbContext context)
        {
            ...
            var banks = new List<Bank>
            {
              ...
              new() { BankName = "Banco do Brasil",         BankCode = "001", Ispb = "00000000", IsActive = false }, // Não implementado
              ...
              new() { BankName = "Banco Inter",             BankCode = "077", Ispb = "00416968", IsActive = false }, // Não implementado
            };
